...
contract Helper {
    ...
    mapping(string humanReadableName => SupportedNetworks enumValue) public supportedNetworksMapping;
    ...
    address constant routerKromaSepolia = 0xA8C0c11bf64AF62CDCA6f93D3769B88BdD7cb93D;
    address constant routerGnosisChiado = 0x19b1bac554111517831ACadc0FD119D23Bb14391;
    address constant routerCeloAlfajores = 0xb00E95b773528E2Ea724DB06B75113F239D15Dca;
    ...
    address constant linkKromaSepolia = 0xa75cCA5b404ec6F4BB6EC4853D177FE7057085c8;
    address constant linkGnosisChiado = 0xDCA67FD8324990792C0bfaE95903B8A64097754F;
    address constant linkCeloAlfajores = 0x32E08557B14FaD8908025619797221281D439071;
    ...
    address constant wethKromaSepolia = 0x4200000000000000000000000000000000000001;
    address constant wxdaiGnosisChiado = 0x18c8a7ec7897177E4529065a7E7B0878358B3BfF;
    address constant wceloCeloAlfajores = 0x99604d0e2EfE7ABFb58BdE565b5330Bb46Ab3Dca;
    ...
    address constant ccipBnMPolygonAmoy = 0xcab0EF91Bee323d1A617c0a027eE753aFd6997E4;
    ...
    address constant ccipBnMKromaSepolia = 0x6AC3e353D1DDda24d5A5416024d6E436b8817A4e;
    address constant ccipBnMGnosisChiado = 0xA189971a2c5AcA0DFC5Ee7a2C44a2Ae27b3CF389;
    address constant ccipBnMCeloAlfajores = 0x7e503dd1dAF90117A1b79953321043d9E6815C72;
    ...
    address constant clCcipLnMPolygonAmoy = 0x3d357fb52253e86c8Ee0f80F5FfE438fD9503FF2;
    ...
    address constant clCcipLnMKromaSepolia = 0x835fcBB6770E1246CfCf52F83cDcec3177d0bb6b;
    address constant clCcipLnMGnosisChiado = 0x30DeCD269277b8094c00B0bacC3aCaF3fF4Da7fB;
    address constant clCcipLnMCeloAlfajores = 0x7F4e739D40E58BBd59dAD388171d18e37B26326f;

    // USDC addresses
    address constant usdcAvalancheFuji = 0x5425890298aed601595a70AB815c96711a31Bc65;
    address constant usdcPolygonAmoy = 0x41E94Eb019C0762f9Bfcf9Fb1E58725BfB0e7582;
        ...
        returns (address router, address linkToken, address wrappedNative, uint64 chainId)
    {
        if (network == SupportedNetworks.ETHEREUM_SEPOLIA) {
            ...
            return (routerKromaSepolia, linkKromaSepolia, wethKromaSepolia, chainIdKromaSepolia);
        } else if (network == SupportedNetworks.GNOSIS_CHIADO) {
            return (routerGnosisChiado, wxdaiGnosisChiado, wxdaiGnosisChiado, chainIdGnosisChiado);
        } else if (network == SupportedNetworks.CELO_ALFAJORES) {
            return (routerCeloAlfajores, wceloCeloAlfajores, wceloCeloAlfajores, chainIdCeloAlfajores);
        }
    }
}
